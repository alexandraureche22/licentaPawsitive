...
const preloadData = async () => {
 ...
 // --- Health Records ---
  await models.HealthRecord.bulkCreate([
    { date: '2026-01-10', type: 'vaccin', description: 'Vaccin antirabic', veterinar: 'Dr. Ureche A.', verified: true, animalId: nacho.id },
    { date: '2026-02-05', type: 'deparazitare', description: 'Deparazitare internă și externă', veterinar: 'Dr. Ureche A.', verified: true, animalId: nacho.id },
    { date: '2026-03-01', type: 'sterilizare', description: 'Sterilizare chirurgicală', veterinar: 'Dr. Godza N.', verified: true, animalId: nacho.id },
    { date: '2026-01-20', type: 'vaccin', description: 'Vaccin polivalent', veterinar: 'Dr. Ureche L.', verified: true, animalId: indigo.id },
    { date: '2026-02-28', type: 'deparazitare', description: 'Deparazitare internă', veterinar: 'Dr. Ureche L.', verified: true, animalId: indigo.id },
    { date: '2026-01-05', type: 'vaccin', description: 'Vaccin antirabic + polivalent', veterinar: 'Dr. Godza N.', verified: true, animalId: tango.id },
    { date: '2026-02-10', type: 'deparazitare', description: 'Deparazitare completă', veterinar: 'Dr. Godza N.', verified: true, animalId: tango.id },
    { date: '2026-03-05', type: 'control', description: 'Control general - sănătos', veterinar: 'Dr. Godza N.', verified: true, animalId: tango.id },
    { date: '2026-01-15', type: 'vaccin', description: 'Vaccin antirabic', veterinar: 'Dr. Ureche A.', verified: true, animalId: fulg.id },
    { date: '2026-02-20', type: 'deparazitare', description: 'Deparazitare completă', veterinar: 'Dr. Ureche A.', verified: true, animalId: fulg.id },
    { date: '2026-03-10', type: 'sterilizare', description: 'Sterilizare', veterinar: 'Dr. Godza N.', verified: true, animalId: fulg.id },
    { date: '2026-01-12', type: 'vaccin', description: 'Vaccin trivalent', veterinar: 'Dr. Ureche L.', verified: true, animalId: visina.id },
    { date: '2026-02-15', type: 'sterilizare', description: 'Sterilizare', veterinar: 'Dr. Ureche L.', verified: true, animalId: visina.id },
    { date: '2026-03-08', type: 'control', description: 'Control - stare excelentă', veterinar: 'Dr. Ureche L.', verified: true, animalId: visina.id },
    { date: '2026-02-01', type: 'vaccin', description: 'Vaccin trivalent', veterinar: 'Dr. Ureche A.', verified: true, animalId: nimbus.id },
    { date: '2026-03-05', type: 'deparazitare', description: 'Deparazitare internă', veterinar: 'Dr. Godza N.', verified: true, animalId: nimbus.id },
    { date: '2026-02-10', type: 'vaccin', description: 'Prima doză vaccin', veterinar: 'Dr. Godza N.', verified: true, animalId: pixel.id },
    { date: '2026-03-01', type: 'deparazitare', description: 'Deparazitare internă', veterinar: 'Dr. Godza N.', verified: true, animalId: pixel.id },
    { date: '2026-01-25', type: 'vaccin', description: 'Vaccin trivalent', veterinar: 'Dr. Ureche L.', verified: true, animalId: solomona.id },
    { date: '2026-02-18', type: 'control', description: 'Control - stare bună', veterinar: 'Dr. Ureche L.', verified: true, animalId: solomona.id },
    { date: '2026-02-05', type: 'control', description: 'Control general - stare bună', veterinar: 'Dr. Godza N.', verified: true, animalId: brioche.id },
    { date: '2026-03-02', type: 'deparazitare', description: 'Deparazitare externă', veterinar: 'Dr. Godza N.', verified: true, animalId: brioche.id },
    { date: '2026-02-12', type: 'control', description: 'Control general - sănătoasă', veterinar: 'Dr. Ureche A.', verified: true, animalId: kumquat.id },
    { date: '2026-01-18', type: 'control', description: 'Control general - sănătos', veterinar: 'Dr. Godza N.', verified: true, animalId: napoleon.id },
    { date: '2026-02-25', type: 'deparazitare', description: 'Deparazitare completă', veterinar: 'Dr. Godza N.', verified: true, animalId: napoleon.id },
    { date: '2026-02-08', type: 'control', description: 'Control general - activ', veterinar: 'Dr. Ureche L.', verified: true, animalId: gizmo.id },
    { date: '2026-01-22', type: 'control', description: 'Control anual - sănătoasă', veterinar: 'Dr. Ureche A.', verified: true, animalId: calypso.id },
    { date: '2026-02-14', type: 'control', description: 'Control - stare bună', veterinar: 'Dr. Godza N.', verified: true, animalId: mango.id },
  ])

  // --- Noutati ---
  await models.News.bulkCreate([
    { title: 'Campanie de sterilizare gratuită în București', summary: 'Asociația Prietenii Animalelor organizează o campanie de sterilizare gratuită.', content: 'Asociația Prietenii Animalelor, în parteneriat cu mai multe clinici veterinare din București, organizează o campanie de sterilizare gratuită pentru câinii și pisicile din adăposturi. Campania se va desfășura pe parcursul lunii martie și vizează reducerea numărului de animale abandonate. Voluntarii pot participa la sesiunile de transport și îngrijire post-operatorie. Înscrierile se fac prin platforma AdoptăCuDrag sau direct la sediul asociației.', category: 'campanii', date: '2026-03-01', userId: admin.id },
    { title: 'Nacho a fost adoptat după 2 ani în adăpost!', summary: 'O poveste emoționantă: Nacho a găsit în sfârșit o familie iubitoare din Cluj-Napoca.', content: 'După doi ani de așteptare în Adăpostul Speranța din București, Nacho — un Border Collie mix energic și loial — a fost adoptat de o familie din Cluj-Napoca. Familia Dumitrescu l-a descoperit pe platformă prin quiz-ul de compatibilitate și s-a îndrăgostit imediat. "Am știut din prima că e al nostru", povestește Maria Dumitrescu. Nacho se bucură acum de plimbări lungi în parcul Central și de o curte mare unde aleargă liber.', category: 'adoptii', date: '2026-02-25', userId: admin.id },
    { title: 'Voluntarii noștri au ajuns la 300!', summary: 'Comunitatea AdoptăCuDrag crește: am depășit pragul de 300 voluntari activi.', content: 'Suntem mândri să anunțăm că echipa de voluntari AdoptăCuDrag a depășit pragul de 300 de membri activi în 15 orașe din România. Voluntarii noștri contribuie zilnic la hrănirea, îngrijirea și socializarea animalelor din adăposturi. De asemenea, ei ajută la organizarea evenimentelor de adopție și la transportul animalelor către noile cămine. Dacă vrei să te alături echipei, vizitează pagina Implică-te.', category: 'comunitate', date: '2026-02-20', userId: admin.id },
    { title: 'Ghid: Cum pregătești casa pentru un companion', summary: 'Tot ce trebuie să știi înainte de a aduce un animal acasă.', content: 'Adopția unui animal este un moment emoționant, dar necesită pregătire. Iată câteva sfaturi esențiale: asigură-te că ai toate produsele necesare (hrană, boluri, pat, jucării), creează un spațiu sigur unde animalul se poate retrage, elimină obiectele periculoase din zona accesibilă, și planifică o vizită la veterinar în prima săptămână. Fii răbdător — adaptarea poate dura între 2 și 4 săptămâni. Nu uita că echipa noastră de suport post-adopție e mereu disponibilă!', category: 'educatie', date: '2026-02-15', userId: admin.id }
  ])
